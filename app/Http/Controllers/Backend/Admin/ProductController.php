...
class ProductController extends Controller
{
    ...
    {
        if (request()->has('type')) {
            $elements = Product::where(request('type'), true)->with('product_attributes.size', 'product_attributes.color')->orderBy('id', 'desc')->get();
        } else {
            $elements = Product::with('product_attributes.size', 'product_attributes.color')->orderBy('id', 'desc')->get();
        }
