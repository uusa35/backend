                ...
                <div class="col-2 col-md-4 col-lg-3">
                    <div class="tt-product thumbprod-center">
                        <div class="tt-image-box">
                            ...
                            <a href="product.html">
                                <span class="tt-img"><img src="{{ asset(env('THUMBNAIL').$element->image) }}" alt="{{ $element->description }}"></span>
                                <span class="tt-img-roll-over"><img src="{{ asset(env('THUMBNAIL').$element->images->first()->image) }}"
                                                                    alt=""></span>
                        ...
                        <div class="tt-description">
                            ...
                            <div class="tt-price">
                                @if($element->isOnSale)
                                    <span class="new-price">{{ $element->convertedSalePrice}} <span>{{ $currency->symbol }}</span>
                                    <span class="old-price">{{ $element->convertedPrice }} <span>{{ $currency->symbol }}</span>
                                @else
                                    <span class="new-price">{{ $element->convertedPrice }} <span>{{ $currency->symbol }}</span>
                                    @endif
                            </div>
