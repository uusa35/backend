@if(isset($homeCategoriesProduct) && $homeCategoriesProduct->isNotEmpty())
                                ...
                                @foreach($element->children as $child)
                                    ...
                                    @if($child->children->isNotEmpty())
                                        @foreach($child->children as $subChild)
                                            <div class="col-2 col-md-4 col-lg-3">
                                                <a href="{{ route('frontend.user.search', ['user_category_id' => $subChild->id ]) }}"
                                                   class="tt-collection-item">
                                                    <div class="tt-image-box"><img src="{{ $subChild->imageThumbLink }}"
                                                                                   alt=""></div>
                                                    <div class="tt-description">
