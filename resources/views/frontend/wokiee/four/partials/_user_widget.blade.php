@if($element)
    <div class="tt-product thumbprod-center p-3">
        <div class="tt-image-box">
            ...
            {{--                    @endif--}}
            <a href="{{ route('frontend.user.show.name', ['id' => $element->id,'name' => str_replace(" ","-",$element->name)]) }}">
        ...
        <div class="tt-description">
            <div class="tt-row">
                <ul class="tt-add-info">
                    <li>
                        <a href="{{ route('frontend.user.show.name', ['id' => $element->id,'name' => str_replace(" ","-",$element->name)]) }}">{{ str_limit($element->slug,25) }}</a>
                        {{--                        @if($element->isDesigner)--}}
            ...
            <h2 class="tt-title">
                <a href="{{ route('frontend.user.show.name', ['id' => $element->id,'name' => str_replace(" ","-",$element->name)]) }}">{{ str_limit($element->description,30,'...') }}</a>
                {{--                @if($element->isDesigner)--}}
