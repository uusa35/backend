                            ...
                            >
                                @elseif($settings->payment_method === 'myfatoorah')
                                    ...
                                    >
                                        ...
                                        >
                                        @elseif($settings->payment_method === 'myfatoorahv2')
                                        <form method="post"
                                        ...
                                        @endif
                                                                <input type="hidden" name="order_id"
                                                                       value="{{ $order->id }}"/>
                                                                <input type="hidden" name="netTotal" value="{{ getCartNetTotal() }}"/>
                                                                <input type="hidden" name="paymentMethod" value="{{ $settings->payment_method }}"/>
                                                                @csrf
                                                                <div class="row">
                                                                    <div class="col-6">
                                                                        <div class="form-group">
                                                                            <label
                                                                                for="loginInputName">{{ trans('general.name') }}
                                                                                *</label>
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="form-group">
                                                                            <label
                                                                                for="loginLastName">{{ trans('general.mobile') }}
                                                                                *</label>
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        @if(!$settings->multi_cart_merchant && isset($owner) && !is_null($owner) && $owner->whatsapp)
                                                                            <a href="{{ route('frontend.order.cash.delivery', ['id' => $order->id, 'whatsapp_url' =>  'https://api.whatsapp.com/send?phone='.$owner->fullWhatsapp.'&url='.route("frontend.invoice.show", $order->id).'&text='.trans("message.order_by_whatsapp",["url" => route("frontend.invoice.show", $order->id)])]) }}"
                                                                               __target="blank"
                                                                               class="btn btn-lg col-lg-6 col-sm-12"
                                                                               style="background-color : #25D366 !important; margin-right : 25%; margin-left: 25%">
