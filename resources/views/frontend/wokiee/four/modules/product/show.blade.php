    ...
    <div class="container-indent">
        ...
        <div class="tt-mobile-product-layout visible-xs">
            <div class="tt-mobile-product-slider arrow-location-center slick-animated-show-js">
                ...
                <div><img src="images/product/product-03-02.jpg" alt=""></div>
                <div><img src="images/product/product-03-03.jpg" alt=""></div>
                <div><img src="images/product/product-03-04.jpg" alt=""></div>
                <div>
                ...
                <div>
                    <div class="tt-video-block">
                        ...
                        <video class="movie" src="{{ $product->video_url }}" poster="{{ asset(env('LARGE').$product->image) }}"></video>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-6 hidden-xs">
                    <div class="product-images-col" data-scrollzoom="false">
                        <div class="item">
                            <img class="zoom-product" src="{{ asset(env('LARGE').$product->image) }}" alt="">
                        </div>
                        <div class="item">
                            <img class="zoom-product" src="{{ asset(env('LARGE').$product->image) }}" alt="">
                        </div>
