                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('sku') ? ' has-error' : '' }}">
                                            <label for="sku" class="control-label">{{ trans('general.sku') }}
                                                *</label>
                                            <input id="sku" type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.sku') }}" name="sku" value="{{ old('sku') }}" placeholder="{{ trans('general.sku') }}" required autofocus>
                                            @if ($errors->has('sku'))
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('duration') ? ' has-error' : '' }}">
                                            ...
                                            <input id="duration" type="number" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.duration') }}" name="duration" value="{{ old('duration') }}" placeholder="{{ trans('general.duration') }}" required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('delivery_time') ? ' has-error' : '' }}">
                                            <label for="delivery_time" class="control-label">{{ trans('general.delivery_time') }}*</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('setup_time') ? ' has-error' : '' }}">
                                            ...
                                            <input id="setup_time" type="number" maxlength="1" max="10" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.setup_time') }}" name="setup_time" value="{{ old('setup_time') }}" placeholder="{{ trans('general.setup_time') }}" required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('individuals') ? ' has-error' : '' }}">
                                            <label for="individuals" class="control-label">{{ trans('general.individuals') }}
                                                *</label>
                                            <input id="individuals" maxlength="2" max="99" type="number" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.individuals') }}" name="individuals" value="" placeholder="{{ trans('general.individuals') }}" required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('delivery_charge') ? ' has-error' : '' }}">
                                            <label for="delivery_charge" class="control-label">{{ trans('general.delivery_charge') }}
                                                *</label>
                                            <input id="delivery_charge" type="number" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.delivery_charge') }}" name="delivery_charge" value="" placeholder="{{ trans('general.delivery_charge') }}" required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                                            <label for="price" class="control-label">{{ trans('general.price') }}
                                                *</label>
                                            <input id="price" type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.price') }}" name="price" value="{{ old('price') }}" placeholder="{{ trans('general.price') }}" required autofocus>
                                            @if ($errors->has('price'))
                                            <span class="help-block">
                                                <strong>
                                                    {{ $errors->first('price') }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('sale_price') ? ' has-error' : '' }}">
                                            <label for="sale_price" class="control-label">{{ trans('general.sale_price') }}
                                                *</label>
                                            <input id="sale_price" type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.sale_price') }}" name="sale_price" value="{{ old('sale_price') }}" placeholder="{{ trans('general.sale_price') }} " required autofocus>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.notes_ar') }}" id="notes_ar" name="notes_ar" aria-multiline="true" maxlength="500" {{ old('notes_ar') }}></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="notes_en" class="control-label">{{ trans('general.notes_en') }}</label>
                                            <textarea type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.notes_en') }}" id="notes_en" name="notes_en" aria-multiline="true" maxlength="500">{{ old('notes_en') }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label">{{ trans('general.categories') }}
                                                *</label>
                                            <select multiple="multiple" class="multi-select" class="form-control " data-container="body" data-placement="top" data-original-title="{{ trans('message.sku') }}" id="my_multi_select1" name="categories[]">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="file" class="control-label">{{ trans('general.more_images') }}
                                                *</label>

                                            <input class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.more_images') }}" name="images[]" placeholder="{{ trans('message.more_images') }}" type="file" multiple />
                                            <div class="help-block text-left">
                                                W * H - Best fit ['1080', '1440'] pixels
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('video_url_one') ? ' has-error' : '' }}">
                                            ...
                                            <input id="video_url_one" type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.video_url_one') }}" name="video_url_one" placeholder="{{ trans('general.video_url_one') }}" value="{{ old('video_url_one') }}" autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('video_url_two') ? ' has-error' : '' }}">
                                            ...
                                            <input id="video_url_two" type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.video_url_two') }}" name="video_url_two" placeholder="{{ trans('general.video_url_two') }}" value="{{ old('video_url_two') }}" autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('start_sale') ? ' has-error' : '' }}">
                                            ...
                                            <div class="input-group date form_datetime">
                                                <input type="text" readonly style="direction: ltr !important;" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.start_sale_date') }}" name="start_sale" value="{{ old('start_sale') ? old('start_sale') : '01 January 2019 - 07:55' }}" required>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date form_datetime">
                                                <input type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.end_sale_date') }}" readonly style="direction: ltr !important;" name="end_sale" value="{{ old('end_sale') ? old('end_sale') : '01 January 2019 - 07:55' }}" required>
                                                <span class="input-group-btn"><button class="btn default date-set" type="button"><i class="fa fa-calendar"></i></button></span>
                                            </div>
                                            <span class="help-block">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('booking_limit') ? ' has-error' : '' }}">
                                            ...
                                            <input id="booking_limit" type="number" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.booking_limit') }}" name="booking_limit" placeholder="{{ trans('general.booking_limit') }}" value="{{ old('booking_limit') }}" autofocus>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" name="active" id="optionsRadios2" checked value="0"> {{ trans('general.not_active') }}</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" name="on_sale" id="optionsRadios2" checked value="0"> {{ trans('general.not_on_sale') }}</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label sbold tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.exclusive') }}">{{ trans('general.exclusive') }}</label></br>
                                            <label class="radio-inline">
                                                <input type="radio" name="exclusive" id="optionsRadios1" value="1">
                                                {{ trans('general.exclusive') }} </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="exclusive" id="optionsRadios2" checked value="0"> {{ trans('general.not_exclusive') }}</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label sbold tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.on_new') }}">{{ trans('general.on_new') }}</label></br>
                                            <label class="radio-inline">
                                                <input type="radio" name="on_new" id="optionsRadios1" value="1">
                                                {{ trans('general.on_new') }} </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="on_new" id="optionsRadios2" checked value="0"> {{ trans('general.not_on_new') }}</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label sbold tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.is_available') }}">{{ trans('general.is_available') }}</label></br>
                                            <label class="radio-inline">
                                                <input type="radio" name="is_available" id="optionsRadios1" value="1">
                                                {{ trans('general.is_available') }} </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="is_available" id="optionsRadios2" checked value="0"> {{ trans('general.not_is_available') }}</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label sbold tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.is_hot_deal') }}">{{ trans('general.is_hot_deal') }}</label></br>
                                            <label class="radio-inline">
                                                <input type="radio" name="is_hot_deal" id="optionsRadios1" value="1">
                                                {{ trans('general.is_hot_deal') }} </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="is_hot_deal" id="optionsRadios2" checked value="0"> {{ trans('general.not_is_hot_deal') }}</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label sbold tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.multi_booking') }}">{{ trans('general.multi_booking') }}</label></br>
                                            <label class="radio-inline">
                                                <input type="radio" name="multi_booking" id="optionsRadios1" value="1">
                                                {{ trans('general.multi_booking') }} </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="multi_booking" id="optionsRadios2" checked value="0"> {{ trans('general.not_multi_booking') }}</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" name="on_home" id="optionsRadios2" checked value="0"> {{ trans('general.not_on_home') }}</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
