                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select id="" name="shipment_package_id"
                                                                ...
                                                                @foreach($shipment_packages as $shipment_package)
                                                                    <option value="{{ $shipment_package->id }}" {{ $element->shipment_package_id === $shipment_package->id ? 'selected' : null  }}>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select id="" name="brand_id" class="form-control tooltips"
                                                                ...
                                                                @foreach($brands as $brand)
                                                                    <option value="{{ $brand->id }}" {{ $element->brand->id === $brand->id ? 'selected' : null  }}>{{ $brand->slug }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
