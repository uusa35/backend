...
@section('content')
    <div class="portlet box blue">
        ...
        <div class="portlet-body form">
            <form class="horizontal-form" role="form" method="POST" action="{{ route('backend.product.store') }}"
                    ...
                    <div class="mt-element-step">
                        <div class="row step-default">
                            ...
                            <div class="col-md-4 bg-grey mt-step-col {{ Route::currentRouteName() === 'backend.attribute.create' ? 'active' : null  }}">
                                ...
                                <div class="mt-step-content font-grey-cascade">different Colors , Sizes , Qunatities for
                                    each product
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('sku') ? ' has-error' : '' }}">
                                    ...
                                    <input id="sku" type="text" class="form-control" name="sku" value="{{ old('sku') }}"
                                           placeholder="name in arabic" required autofocus>
                                    @if ($errors->has('sku'))
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('name_ar') ? ' has-error' : '' }}">
                                ...
                                <input id="name_ar" type="text" class="form-control" name="name_ar"
                                       value="{{ old('name_ar') }}" placeholder="name in arabic" required autofocus>
                        ...
                        <div class="col-md-4">
                            <div class="form-group{{ $errors->has('name_en') ? ' has-error' : '' }}">
                                ...
                                <input id="name_en" type="text" class="form-control" name="name_en"
                                       value="{{ old('name_en') }}" placeholder="name in english" required autofocus>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                                ...
                                <input id="price" type="text" class="form-control" name="price"
                                       value="{{ old('price') }}" placeholder="price" maxlength="5" required autofocus>
                                @if ($errors->has('price'))
                                    <span class="help-block">
                                <strong>
                                    {{ $errors->first('price') }}
                        ...
                        <div class="col-md-2">
                            <div class="form-group{{ $errors->has('sale_price') ? ' has-error' : '' }}">
                                ...
                                <input id="sale_price" type="text" class="form-control" name="sale_price" maxlength="5"
                                       value="{{ old('sale_price') }}" placeholder="sale_price" autofocus>
                        ...
                        <div class="col-md-2">
                            <div class="form-group{{ $errors->has('quantity') ? ' has-error' : '' }}">
                                ...
                                <input id="quantity" type="text" class="form-control" name="quantity" maxlength="5"
                                       value="{{ old('quantity') }}" placeholder="quantity" autofocus>
                        ...
                        <div class="col-md-4">
                            <div class="form-group{{ $errors->has('weight') ? ' has-error' : '' }}">
                                ...
                                <input id="weight" type="text" class="form-control" name="weight"
                                       value="{{ old('weight') }}" placeholder="weight" required autofocus>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group{{ $errors->has('start_sale') ? ' has-error' : '' }}">
                                ...
                                <input id="start_sale" type="date" class="form-control" name="start_sale"
                                       value="{{ old('start_sale') }}" placeholder="name in arabic" autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date form_datetime">
                                    <input type="text" size="16" readonly class="form-control" name="end_sale"
                                           ...
                                           required>
                                    <span class="input-group-btn"><button class="btn default date-set" type="button"><i
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('notes_ar') ? ' has-error' : '' }}">
                                ...
                                <input id="notes_ar" type="text" class="form-control" name="notes_ar"
                                       value="{{ old('notes_ar') }}" placeholder="notes_ar arabic" autofocus>
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('notes_en') ? ' has-error' : '' }}">
                                ...
                                <input id="notes_en" type="text" class="form-control" name="notes_en"
                                       value="{{ old('notes_en') }}" placeholder="notes_en arabic" autofocus>
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('video_url_one') ? ' has-error' : '' }}">
                                ...
                                <input id="video_url_one" type="text" class="form-control" name="video_url_one"
                                       value="{{ old('video_url_one') }}" placeholder="video_url_one arabic" autofocus>
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('video_url_two') ? ' has-error' : '' }}">
                                ...
                                <input id="video_url_two" type="text" class="form-control" name="video_url_two"
                                       value="{{ old('video_url_two') }}" placeholder="video_url_two arabic" autofocus>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="home_delivery_available" id="optionsRadios3" checked
                                           value="1"> home_delivery_available</label>
                                <label class="radio-inline">
                                    <input type="radio" name="home_delivery_available" id="optionsRadios4" value="0">not
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="shipment_available" id="optionsRadios3" checked value="1">
                                    shipment_available</label>
                                <label class="radio-inline">
                                    <input type="radio" name="shipment_available" id="optionsRadios4" value="0">not
                                    shipment_available</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="exclusive" id="optionsRadios3" checked value="1">
                                    exclusive</label>
                                <label class="radio-inline">
                                    <input type="radio" name="exclusive" id="optionsRadios4" value="0">not
                                    exclusive</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="is_hot_deal" id="optionsRadios7" checked value="1">
                                    is_hot_deal</label>
                                <label class="radio-inline">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="check_stock" id="optionsRadios5" checked value="1">
                                    check_stock</label>
                                <label class="radio-inline">
                                    <input type="radio" name="check_stock" id="optionsRadios6" value="0">not in
                                    check_stock</label>
