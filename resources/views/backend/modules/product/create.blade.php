                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="home_delivery_available" id="optionsRadios3" value="1"> home_delivery_available</label>
                            <label class="radio-inline">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <label class="radio-inline">
                                ...
                                is_hot_deal</label>
                            <label class="radio-inline">
                                <input type="radio" name="is_hot_deal" id="optionsRadios8" checked value="0">not is_hot_deal</label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="check_stock" id="optionsRadios5" value="1">
                                check_stock</label>
                            <label class="radio-inline">
