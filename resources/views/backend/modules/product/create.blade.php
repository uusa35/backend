                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group {{ $errors->has('sku') ? ' has-error' : '' }}">
                                                ...
                                                <input id="sku" type="text" class="form-control" name="sku"
                                                       value="{{ old('sku') }}"
                                                       placeholder="{{ trans('general.sku') }}" required autofocus>
                                                @if ($errors->has('sku'))
                                ...
                                <strong>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('name_ar') ? ' has-error' : '' }}">
                                            <label for="name_ar"
                                                   class="control-label">{{ trans('general.name_arabic') }}*</label>
                                ...
                                <strong>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('name_en') ? ' has-error' : '' }}">
                                            <label for="name_en"
                                                   class="control-label">{{ trans('general.name_english') }}*</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                                            ...
                                            <input id="price" type="text" class="form-control" name="price"
                                                   value="{{ old('price') }}" placeholder="{{ trans('general.price') }}"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group{{ $errors->has('start_sale') ? ' has-error' : '' }}">
                                            ...
                                            <input id="start_sale" type="date" class="form-control" name="start_sale"
                                                   ...
                                                   placeholder="{{ trans('general.start_sale_date') }}" autofocus>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('notes_ar') ? ' has-error' : '' }}">
                                            ...
                                            <input id="notes_ar" type="text" class="form-control" name="notes_ar"
                                                   value="{{ old('notes_ar') }}" placeholder="{{ trans('general.notes_arabic') }} "
                                                   autofocus>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('notes_en') ? ' has-error' : '' }}">
                                            ...
                                            <input id="notes_en" type="text" class="form-control" name="notes_en"
                                                   value="{{ old('notes_en') }}" placeholder="{{ trans('general.notes_english') }}"
                                                   autofocus>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('video_url_one') ? ' has-error' : '' }}">
                                            ...
                                            <input id="video_url_one" type="text" class="form-control" name="video_url_one"
                                                   ...
                                                   placeholder="{{ trans('general.video_url_one') }}" autofocus>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('video_url_two') ? ' has-error' : '' }}">
                                            ...
                                            <input id="video_url_two" type="text" class="form-control" name="video_url_two"
                                                   ...
                                                   placeholder="{{ trans('general.video_url_two') }}" autofocus>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <label class="radio-inline">
                        <input type="radio" name="home_delivery_available" id="optionsRadios4" checked
                               value="0">not
                        home_delivery_available</label>
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <label class="radio-inline" data-toggle="tooltip" data-placement="bottom"
                           data-html="true" title=" If Not whenever a successful order is made. qty will not be decreased
                                        accordingly.">
                        <input type="radio" data-toggle="tooltip" data-placement="bottom" title="hello"
                    ...
                    <label class="radio-inline" data-toggle="tooltip" data-placement="bottom"
                        ...
                        <input type="radio" name="check_stock" id="optionsRadios6" checked value="0">not in
                        check_stock</label>
