    ...
    <div class="col-md-12">
        ...
        <div class="portlet light ">
            ...
            <div class="portlet-body">
                @include('backend.partials._admin_instructions',['title' => trans('general.packages') ,'message' => trans('message.index_package')])/div>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu">
                                        ...
                                        <li>
                                            ...
                                            <form method="post" id="delete-{{ $element->id }}" action="{{ route('backend.package.destroy',$element->id) }}">
                                                @csrf
