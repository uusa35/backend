...
<div class="portlet box blue">
    ...
    <div class="portlet-body">
        @include('backend.partials._admin_instructions',['title' => trans('general.packages') ,'message' => trans('message.admin_package_message')])
        <div class="portlet-body form">
            <form class="horizontal-form" role="form" method="POST" action="{{ route('backend.package.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="form-body">
                    <h3 class="form-section">{{ trans('general.create_shipment_package') }}</h3>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                            ...
                                            <input id="name" type="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="{{ trans('general.name_ar') }}" required autofocus>
                                            @if ($errors->has('name'))
                    ...
                    <div class="portlet box blue ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i> {{ trans('general.shipment_attributes_details') }}
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <div class="form-body">
