                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group{{ $errors->has('value') ? ' has-error' : '' }}">
                            ...
                            <input id="value" type="number" class="form-control" max="99" maxlength="3" name="value" value="{{ old('value') }}" placeholder="value" required autofocus>
                            @if ($errors->has('value'))
                    ...
                    <div class="col-md-4">
                        <div class="form-group{{ $errors->has('minimum_charge') ? ' has-error' : '' }}">
                            ...
                            <input id="minimum_charge" type="number" class="form-control" name="minimum_charge" value="{{ old('minimum_charge') }}" placeholder="minimum charge" maxlength="3" max="999" required autofocus>
                    ...
                    <div class="col-md-4">
                        <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
                            ...
                            <input id="code" type="text" class="form-control" name="code" value="{{ old('code') }}" placeholder="code" required autofocus>
                            @if ($errors->has('code'))
                            <span class="help-block">
                                <strong>
                                    {{ $errors->first('code') }}
                    ...
                    <div class="col-md-6">
                        <div class="form-group{{ $errors->has('due_date') ? ' has-error' : '' }}">
                            ...
                            <input id="due_date" type="date" class="form-control" name="due_date" value="{{ old('due_date') }}" placeholder="due_date in arabic" maxlength="4" required autofocus>
