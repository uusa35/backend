                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                            <label for="name_ar" class="control-label">{{ trans('general.name') }}
                                                *</label>
                                            <input id="name_ar" type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.name') }}" name="name" value="{{ old('name') }}" placeholder="{{ trans('general.name') }}" required autofocus>
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.description_arabic') }}" id="description_ar" name="description_ar" aria-multiline="true" maxlength="500" {{ old('description_ar') }}></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="description" class="control-label">{{ trans('general.description_english') }}</label>
                                            <textarea type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.description_english') }}" id="description_en" name="description_en" aria-multiline="true" maxlength="500">{{ old('description_en') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('service_en') ? ' has-error' : '' }}">
                                            ...
                                            <input id="service_en" type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.service_en') }}" name="service_en" value="{{ old('service_en') }}" placeholder="{{ trans('general.service_en') }}" required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('service_ar') ? ' has-error' : '' }}">
                                            ...
                                            <input id="service_ar" type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.service_ar') }}" name="service_ar" value="{{ old('service_ar') }}" placeholder="{{ trans('general.service_ar') }}" required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                            ...
                                            <input id="phone" type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.phone') }}" name="phone" placeholder="{{ trans('general.phone') }}" value="{{ old('phone') }}" autofocus>
                                            @if ($errors->has('phone'))
                                            <span class="help-block">
                                                <strong>
                                                    {{ $errors->first('phone') }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('fax') ? ' has-error' : '' }}">
                                            ...
                                            <input id="fax" type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.fax') }}" name="fax" placeholder="{{ trans('general.fax') }}" value="{{ old('fax') }}" autofocus>
                                            @if ($errors->has('fax'))
                                            <span class="help-block">
                                                <strong>
                                                    {{ $errors->first('fax') }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.banner') }}" name="banner" placeholder="{{ trans('general.banner') }}">

                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('bg') ? ' has-error' : '' }}">
                                            <label for="demo" class="control-label">{{ trans('general.bg') }}
                                                *</label>
                                            <input type="file" id="hue-demo" class="form-control tooltips demo" data-container="body" data-placement="top" data-original-title="{{ trans('message.bg') }}" data-control="hue" name="bg" value="#ff6161">
                                            @if ($errors->has('demo'))
                                            <span class="help-block">
                                                <strong>
                                                    {{ $errors->first('demo') }}
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                            ...
                                            <input id="address" type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.address') }}" name="address" placeholder="{{ trans('general.address') }}" value="{{ old('address') }}" autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('area') ? ' has-error' : '' }}">
                                            ...
                                            <input id="area" type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.area') }}" name="area" placeholder="{{ trans('general.area') }}" value="{{ old('area') }}" autofocus>
                                            @if ($errors->has('area'))
                                            <span class="help-block">
                                                <strong>
                                                    {{ $errors->first('area') }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('block') ? ' has-error' : '' }}">
                                            ...
                                            <input id="block" type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.block') }}" name="block" placeholder="{{ trans('general.block') }}" value="{{ old('block') }}" autofocus>
                                            @if ($errors->has('block'))
                                            <span class="help-block">
                                                <strong>
                                                    {{ $errors->first('block') }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('street') ? ' has-error' : '' }}">
                                            ...
                                            <input id="street" type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.street') }}" name="street" placeholder="{{ trans('general.street') }}" value="{{ old('street') }}" autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('building') ? ' has-error' : '' }}">
                                            ...
                                            <input id="building" type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.building') }}" name="building" placeholder="{{ trans('general.building') }}" value="{{ old('building') }}" autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('floor') ? ' has-error' : '' }}">
                                            ...
                                            <input id="floor" type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.floor') }}" name="floor" placeholder="{{ trans('general.floor') }}" value="{{ old('floor') }}" autofocus>
                                            @if ($errors->has('floor'))
                                            <span class="help-block">
                                                <strong>
                                                    {{ $errors->first('floor') }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('apartment') ? ' has-error' : '' }}">
                                            ...
                                            <input id="apartment" type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.apartment') }}" name="apartment" placeholder="{{ trans('general.apartment') }}" value="{{ old('apartment') }}" autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select id="single" class="form-control tooltips select2" data-container="body" data-placement="top" data-original-title="{{ trans('message.country_id') }}" name="country_id" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group{{ $errors->has('path') ? ' has-error' : '' }}">
                                                    ...
                                                    <input id="path" type="file" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.path') }}" name="path" placeholder="{{ trans('general.path') }}" value="{{ old('path') }}" autofocus>
                                                    @if ($errors->has('path'))
                                                    <span class="help-block">
                                                        <strong>
                                                            {{ $errors->first('path') }}
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group{{ $errors->has('website') ? ' has-error' : '' }}">
                                                    ...
                                                    <input id="website" type="url" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.website') }}" name="website" placeholder="{{ trans('general.website') }}" value="{{ old('website') }}" autofocus>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group{{ $errors->has('facebook') ? ' has-error' : '' }}">
                                                    ...
                                                    <input id="facebook" type="url" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.facebook') }}" name="facebook" placeholder="{{ trans('general.facebook') }}" value="{{ old('facebook') }}" autofocus>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group{{ $errors->has('instagram') ? ' has-error' : '' }}">
                                                    ...
                                                    <input id="instagram" type="url" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.instagram') }}" name="instagram" placeholder="{{ trans('general.instagram') }}" value="{{ old('instagram') }}" autofocus>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group{{ $errors->has('youtube') ? ' has-error' : '' }}">
                                                    ...
                                                    <input id="youtube" type="url" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.youtube') }}" name="youtube" placeholder="{{ trans('general.youtube') }}" value="{{ old('youtube') }}" autofocus>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group{{ $errors->has('twitter') ? ' has-error' : '' }}">
                                                    ...
                                                    <input id="twitter" type="url" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.twitter') }}" name="twitter" placeholder="{{ trans('general.twitter') }}" value="{{ old('twitter') }}" autofocus>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group{{ $errors->has('iphone') ? ' has-error' : '' }}">
                                                    ...
                                                    <input id="iphone" type="url" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.iphone') }}" name="iphone" placeholder="{{ trans('general.iphone') }}" value="{{ old('iphone') }}" autofocus>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group{{ $errors->has('android') ? ' has-error' : '' }}">
                                                    ...
                                                    <input id="android" type="url" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.android') }}" name="android" placeholder="{{ trans('general.android') }}" value="{{ old('android') }}" autofocus>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group{{ $errors->has('balance') ? ' has-error' : '' }}">
                                                    ...
                                                    <input id="balance" type="number" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="{{ trans('message.balance') }}" name="balance" placeholder="{{ trans('general.balance') }}" value="{{ old('balance') }}" autofocus>
