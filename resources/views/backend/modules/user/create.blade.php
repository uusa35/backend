                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('service_en') ? ' has-error' : '' }}">
                                            ...
                                            <input id="service_en" type="text" class="form-control" name="service_en"
                                                   ...
                                                   placeholder="{{ trans('general.service_en') }}" required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('service_ar') ? ' has-error' : '' }}">
                                            ...
                                            <input id="service_ar" type="text" class="form-control" name="service_ar"
                                                   ...
                                                   placeholder="{{ trans('general.service_ar') }}" required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('password') ? ' has-error' : '' }}">
                                            <label for="password" class="control-label">{{ trans('general.password') }}
                                                *</label>
                                            <input id="password" type="password" class="form-control" name="password"
                                                   value="" placeholder="{{ trans('general.password') }}" required
                                                   autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                                            <label for="password_confirmation"
                                                   class="control-label">{{ trans('general.password_confirmation') }}
                                                *</label>
                                            <input id="password_confirmation" type="text" class="form-control"
                                                   name="password_confirmation" value=""
                                                   placeholder="{{ trans('general.password_confirmation') }}" required
                                                   autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                            ...
                                            <input id="email" type="text" class="form-control" name="email"
                                                   value="{{ old('email') }}" placeholder="{{ trans('general.email') }}"
                                                   required autofocus>
                                            @if ($errors->has('email'))
                                                <span class="help-block">
                                            <strong>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                            ...
                                            <input id="phone" type="text" class="form-control" name="phone"
                                                   placeholder="{{ trans('general.phone') }}" value="{{ old('phone') }}"
                                                   autofocus>
                                            @if ($errors->has('phone'))
                                                <span class="help-block">
                                            <strong>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" name="banner"
                                                   placeholder="{{ trans('general.banner') }}" required>
                                            <div class="help-block text-left">
                                                W * H - Best fit ['1080', '1440'] pixels
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('area') ? ' has-error' : '' }}">
                                            ...
                                            <input id="area" type="text" class="form-control" name="area"
                                                   placeholder="{{ trans('general.area') }}" value="{{ old('area') }}"
                                                   autofocus>
                                            @if ($errors->has('area'))
                                                <span class="help-block">
                                            <strong>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('block') ? ' has-error' : '' }}">
                                            ...
                                            <input id="block" type="text" class="form-control" name="block"
                                                   placeholder="{{ trans('general.block') }}" value="{{ old('block') }}"
                                                   autofocus>
                                            @if ($errors->has('block'))
                                                <span class="help-block">
                                            <strong>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('floor') ? ' has-error' : '' }}">
                                            ...
                                            <input id="floor" type="text" class="form-control" name="floor"
                                                   placeholder="{{ trans('general.floor') }}" value="{{ old('floor') }}"
                                                   autofocus>
                                            @if ($errors->has('floor'))
                                                <span class="help-block">
                                            <strong>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group{{ $errors->has('facebook') ? ' has-error' : '' }}">
                                                    ...
                                                    <input id="facebook" type="text" class="form-control"
                                                           name="facebook" placeholder="{{ trans('general.facebook') }}"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group{{ $errors->has('whatsapp') ? ' has-error' : '' }}">
                                                    ...
                                                    <input id="whatsapp" type="text" class="form-control"
                                                           name="whatsapp" placeholder="{{ trans('general.whatsapp') }}"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group{{ $errors->has('latitude') ? ' has-error' : '' }}">
                                                    ...
                                                    <input id="latitude" type="text" class="form-control"
                                                           name="latitude" placeholder="{{ trans('general.latitude') }}"
