                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('bg') ? ' has-error' : '' }}">
                                            <label for="demo" class="control-label">{{ trans('general.bg') }}
                                                *</label>
                                            <input type="text" id="hue-demo" class="form-control tooltips demo" data-container="body" data-placement="top" data-original-title="{{ trans('message.bg') }}" data-control="hue" name="bg" value="#ff6161">
                                            @if ($errors->has('demo'))
                                            <span class="help-block">
                                                <strong>
                                                    {{ $errors->first('demo') }}
