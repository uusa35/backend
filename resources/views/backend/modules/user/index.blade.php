                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu">
                                        ...
                                        <li>
                                            <a href="{{ route('backend.user.edit',$element->id) }}">
                                                <i class="fa fa-fw fa-check-circle"></i> {{ trans('general.edit') }}</a>
                                        </li>
                                        @endif
                                        <li>
                                        ...
                                        <li>
                                            <a data-toggle="modal" href="#" data-target="#basic" data-title="Delete" data-content="Are you sure you want to delete {{ $element->name  }}?
                                            ...
                                            <form method="post" id="delete-{{ $element->id }}" action="{{ route('backend.admin.user.destroy',$element->id) }}">
                                                @csrf
