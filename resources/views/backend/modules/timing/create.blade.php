...
@section('content')
    <div class="portlet box blue">
        ...
        <div class="portlet-body form">
            <form class="horizontal-form" role="form" method="POST" action="{{ route('backend.admin.timing.store') }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('day') ? ' has-error' : '' }}">
                                            ...
                                            <input id="day" type="text" class="form-control" day="day"
                                                   value="{{ old('day') }}" placeholder="{{ trans('general.day') }}"
                                                   required autofocus>
                                            @if ($errors->has('day'))
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('day_name_ar') ? ' has-error' : '' }}">
                                            <label for="day_name_ar"
                                                   class="control-label">{{ trans('general.day_name_ar') }}*</label>
                                            <input id="day_name_ar" type="text" class="form-control" day="day_name_ar"
                                                   value="{{ old('day_name_ar') }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('day_name_en') ? ' has-error' : '' }}">
                                            <label for="day_name_en"
                                                   class="control-label">{{ trans('general.day_name_en') }}*</label>
                                            <input id="day_name_en" type="text" class="form-control" day="day_name_en"
                                                   value="{{ old('day_name_en') }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('start') ? ' has-error' : '' }}">
                                            ...
                                            <input id="start" type="text" class="form-control" day="start"
                                                   value="{{ old('start') }}" placeholder="{{ trans('general.start') }}"
                                                   required autofocus>
                                            @if ($errors->has('start'))
                                                <span class="help-block">
                                            <strong>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('end') ? ' has-error' : '' }}">
                                            ...
                                            <input id="end" type="text" class="form-control" day="end"
                                                   value="{{ old('end') }}" placeholder="{{ trans('general.end') }}"
                                                   required autofocus>
                                            @if ($errors->has('end'))
                                                <span class="help-block">
                                            <strong>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('type') ? ' has-error' : '' }}">
                                            ...
                                            <input id="type" type="text" class="form-control" day="type"
                                                   value="{{ old('type') }}" placeholder="{{ trans('general.type') }}"
                                                   required autofocus>
                                            @if ($errors->has('type'))
                                                <span class="help-block">
                                            <strong>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('week_start') ? ' has-error' : '' }}">
                                            <label for="week_start"
                                                   class="control-label">{{ trans('general.week_start') }}*</label>
                                            <input id="week_start" type="text" class="form-control" day="week_start"
                                                   value="{{ old('week_start') }}"
                                                   placeholder="{{ trans('general.week_start') }}" required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('day_no') ? ' has-error' : '' }}">
                                            ...
                                            <input id="day_no" type="day_no" class="form-control" day="day_no" value=""
                                                   placeholder="{{ trans('general.day_no') }}" required autofocus>
