                                            ...
                                            <div class="col">
                                                <div class="input-group">
                                                    <input id="start" type="text"
                                                           class="form-control timepicker timepicker-24" name="start"
                                                           value="{{ old('start') }}"
                                            ...
                                            <div class="col">
                                                <div class="input-group">
                                                    <input id="end" type="text"
                                                           ...
                                                           value="{{ old('end') }}"
                                                           placeholder="{{ trans('general.end') }}" required autofocus>
                                                    <span class="input-group-btn">
                                                    <button class="btn default" type="button">
                                                        <i class="fa fa-clock-o"></i>
                                                    </button>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="is_off" id="optionsRadios2" checked
                                                           value="0">
                                                    not_is_off</label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="allow_multi_select" id="optionsRadios1"
                                                           value="1"> allow_multiselect </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="allow_multi_select" id="optionsRadios2"
