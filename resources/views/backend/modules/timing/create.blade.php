...
<div class="portlet box blue">
    ...
    <div class="portlet-body">
        ...
        <div class="portlet-body form">
            <form class="horizontal-form" role="form" method="POST" action="{{ route('backend.timing.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group {{ $errors->has('notes_en') ? ' has-error' : '' }}">
                                        <label for="notes_en" class="control-label">{{ trans('general.notes_en') }}
                                            *</label>
                ...
                <<<<<<< HEAD <div class="portlet box blue ">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <div class="portlet box blue ">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    >>>>>>> 3313eab3b087e7b7a7058fcec569619505bf13d4
                                </div>
                            </div>
                            <div class="portlet-body form">
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <<<<<<< HEAD <label for="single" class="control-label">{{ trans('general.service') }}</label>
                                                    <select id="single" class="form-control select2" name="service_id">
                                                        <option value="">{{ trans('general.choose_service') }}</option>
                                                        @foreach($services as $service)
                                                        <option value="{{ $service->id }}">{{ $service->name_ar }}</option>
                                                    ...
                                                    <label class="radio-inline">
                                                        <input type="radio" name="allow_multi_select" id="optionsRadios1" value="1"> {{ trans('general.yes') }}</label>
                                                    <label class="radio-inline">
                                                        <input type="radio" name="allow_multi_select" id="optionsRadios2" checked value="0"> {{ trans('general.no') }}</label>
                                                    >>>>>>> 3313eab3b087e7b7a7058fcec569619505bf13d4
                                            </div>
                                        </div>
                                        @else
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <<<<<<< HEAD <label for="single" class="control-label">{{ trans('general.service') }}</label>
                                                    ...
                                                    <label class="radio-inline">
                                                        <input type="radio" name="is_available" id="optionsRadios2" checked value="0"> {{ trans('general.no') }}</label>
                                                    >>>>>>> 3313eab3b087e7b7a7058fcec569619505bf13d4
                                            </div>
                                        </div>
                                        @endcan
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" name="is_off" id="optionsRadios1" value="1">
                                                is_off
                                            </label>
                                            <label class="radio-inline">
