...
<<<<<<< HEAD @section('breadcrumbs') {{ Breadcrumbs::render('backend.slide.create') }} @endsection @section('content') <div class="clearfix">
    </div>
    <div class="portlet-body form">
        <form role="form" method="post" action="{{ route('backend.admin.slide.store') }}" enctype="multipart/form-data">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <form class="horizontal-form" role="form" method="POST" action="{{ route('backend.admin.slide.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-4">
