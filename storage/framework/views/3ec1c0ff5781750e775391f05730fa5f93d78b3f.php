...
<div class="portlet box blue">
    ...
    <div class="portlet-body">
        <?php echo $__env->make('backend.partials._admin_instructions',['title' => trans('general.sildes') ,'message' => trans('message.admin_slide_message')], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        ...
                        <div class="portlet-body form">
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-md-line-input">
                                            <input type="number" max="99" maxlength="2" class="form-control" name="order" placeholder="<?php echo e(trans('general.sequence')); ?>">
                                        ...
                                        <div class="md-radio-inline">
                                            ...
                                            <div class="md-radio">
                                                ...
                                                <label for="radio54">
                                                    <span></span>
                                                    <span class="check"></span>
                                                    <span class="box"></span> <?php echo e(trans('general.no')); ?></label>
                                            </div>
                                        </div>
                                    </div>
