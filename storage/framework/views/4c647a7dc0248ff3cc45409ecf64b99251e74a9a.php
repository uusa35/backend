...
<?php echo e(Breadcrumbs::render('backend.admin.role.create')); ?>
...
<div class="portlet box blue">
    ...
    <div class="portlet-body">
        <?php echo $__env->make('backend.partials._admin_instructions',['title' => trans('general.roles') ,'message' => trans('message.admin_role_message')], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" class="form-control" placeholder="<?php echo e(trans('general.name')); ?>" value="<?php echo e(old('name_ar')); ?>" name="name" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="radio-list">
                                                    <label class="radio-inline">
                                                        <input type="radio" name="is_visible" id="optionsRadios5" value="1" checked> <?php echo e(trans('general.is_visible')); ?> </label>
                                                    <label class="radio-inline">
                                                        <input type="radio" name="is_visible" id="optionsRadios6" value="0"> <?php echo e(trans('general.not_is_visible')); ?></label>
                                                </div>
