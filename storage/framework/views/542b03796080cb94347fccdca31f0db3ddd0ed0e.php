...
<?php echo e(Breadcrumbs::render('backend.admin.term.index')); ?>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu">
                                        <li>
                                            <a href="<?php echo e(route('backend.admin.term.edit',$element->id)); ?>">
                                        ...
                                        <li>
                                            ...
                                            <form method="post" id="delete-<?php echo e($element->id); ?>" action="<?php echo e(route('backend.admin.term.destroy',$element->id)); ?>">
                                                <?php echo csrf_field(); ?>
