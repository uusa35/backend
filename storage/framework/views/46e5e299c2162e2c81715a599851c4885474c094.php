                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group <?php echo e($errors->has('duration') ? ' has-error' : ''); ?>">
                                            ...
                                            <input id="duration" type="number" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="<?php echo e(trans('message.duration')); ?>" name="duration" value="<?php echo e(old('duration')); ?>" placeholder="<?php echo e(trans('general.duration')); ?>" required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group <?php echo e($errors->has('setup_time') ? ' has-error' : ''); ?>">
                                            ...
                                            <input id="setup_time" type="number" maxlength="1" max="10" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="<?php echo e(trans('message.setup_time')); ?>" name="setup_time" value="<?php echo e(old('setup_time')); ?>" placeholder="<?php echo e(trans('general.setup_time')); ?>" required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group <?php echo e($errors->has('individuals') ? ' has-error' : ''); ?>">
                                            <label for="individuals" class="control-label"><?php echo e(trans('general.individuals')); ?>
                                                ...
                                                *</label>
                                            <input id="individuals" maxlength="2" max="99" type="number" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="<?php echo e(trans('message.individuals')); ?>" name="individuals" value="" placeholder="<?php echo e(trans('general.individuals')); ?>" required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group <?php echo e($errors->has('delivery_charge') ? ' has-error' : ''); ?>">
                                            <label for="delivery_charge" class="control-label"><?php echo e(trans('general.delivery_charge')); ?>
                                                ...
                                                *</label>
                                            <input id="delivery_charge" type="number" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="<?php echo e(trans('message.delivery_charge')); ?>" name="delivery_charge" value="" placeholder="<?php echo e(trans('general.delivery_charge')); ?>" required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group<?php echo e($errors->has('price') ? ' has-error' : ''); ?>">
                                            <label for="price" class="control-label"><?php echo e(trans('general.price')); ?>
                                                ...
                                                *</label>
                                            <input id="price" type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="<?php echo e(trans('message.price')); ?>" name="price" value="<?php echo e(old('price')); ?>" placeholder="<?php echo e(trans('general.price')); ?>" required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group<?php echo e($errors->has('sale_price') ? ' has-error' : ''); ?>">
                                            <label for="sale_price" class="control-label"><?php echo e(trans('general.sale_price')); ?>
                                                ...
                                                *</label>
                                            <input id="sale_price" type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="<?php echo e(trans('message.sale_price')); ?>" name="sale_price" value="<?php echo e(old('sale_price')); ?>" placeholder="<?php echo e(trans('general.sale_price')); ?> " required autofocus>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="<?php echo e(trans('message.notes_ar')); ?>" id="notes_ar" name="notes_ar" aria-multiline="true" maxlength="500" <?php echo e(old('notes_ar')); ?>></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="notes_en" class="control-label"><?php echo e(trans('general.notes_en')); ?></label>
                                            <textarea type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="<?php echo e(trans('message.notes_en')); ?>" id="notes_en" name="notes_en" aria-multiline="true" maxlength="500"><?php echo e(old('notes_en')); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label"><?php echo e(trans('general.categories')); ?>
                                                ...
                                                *</label>
                                            <select multiple="multiple" class="multi-select" class="form-control " data-container="body" data-placement="top" data-original-title="<?php echo e(trans('message.sku')); ?>" id="my_multi_select1" name="categories[]">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group<?php echo e($errors->has('video_url_one') ? ' has-error' : ''); ?>">
                                            ...
                                            <input id="video_url_one" type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="<?php echo e(trans('message.video_url_one')); ?>" name="video_url_one" placeholder="<?php echo e(trans('general.video_url_one')); ?>" value="<?php echo e(old('video_url_one')); ?>" autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group<?php echo e($errors->has('video_url_two') ? ' has-error' : ''); ?>">
                                            ...
                                            <input id="video_url_two" type="text" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="<?php echo e(trans('message.video_url_two')); ?>" name="video_url_two" placeholder="<?php echo e(trans('general.video_url_two')); ?>" value="<?php echo e(old('video_url_two')); ?>" autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group<?php echo e($errors->has('booking_limit') ? ' has-error' : ''); ?>">
                                            ...
                                            <input id="booking_limit" type="number" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="<?php echo e(trans('message.booking_limit')); ?>" name="booking_limit" placeholder="<?php echo e(trans('general.booking_limit')); ?>" value="<?php echo e(old('booking_limit')); ?>" autofocus>
                        ...
                        <div class="portlet-body form">
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label sbold tooltips" data-container="body" data-placement="top" data-original-title="<?php echo e(trans('message.multi_booking')); ?>"><?php echo e(trans('general.multi_booking')); ?></label></br>
                                            <label class="radio-inline">
