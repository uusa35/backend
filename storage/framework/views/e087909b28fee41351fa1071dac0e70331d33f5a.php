...
<?php echo e(Breadcrumbs::render('backend.admin.aboutus.create')); ?>
...
<div class="portlet box blue">
    ...
    <div class="portlet-body">
        <?php echo $__env->make('backend.partials._admin_instructions',['title' => trans('general.aboutus') ,'message' =>
        trans('message.admin_aboutus_message')], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <div class="portlet-body form">
            <form class="horizontal-form" role="form" method="POST" action="<?php echo e(route('backend.admin.aboutus.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="form-body">
                    <h3 class="form-section"><?php echo e(trans('general.create_aboutus')); ?></h3>
                    <div class="portlet box blue ">
