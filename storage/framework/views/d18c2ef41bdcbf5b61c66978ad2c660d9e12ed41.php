    ...
    <?php if($categories->isNotEmpty()): ?>
        <?php $__currentLoopData = $categories->where('is_parent', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="dropdown megamenu">
                <a href="<?php echo e(route('frontend.search',['category_id'])); ?>"><?php echo e(str_limit($cat->name,20)); ?></a>
                                            ...
                                            <a href="listing-right-column.html" class="tt-title-submenu">
                                                <?php if($sub->imageLargeLink): ?>
                                                    ...
                                                    <img class="img-menu-category img-responsive"
                                                         src="<?php echo e($sub->imageLargeLink); ?>"
                                                         data-src="<?php echo e($sub->imageLargeLink); ?>"
                                            ...
                                            <?php if($sub->children->isNotEmpty()): ?>
                                                <ul class="tt-megamenu-submenu">
                                                    <?php $__currentLoopData = $sub->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li>
                                                            <a href="<?php echo e(route('frontend.search',['category_id'])); ?>"><?php echo e($child->name); ?>
                            ...
                            <?php if($cat->imageLargeLink): ?>
                                <div class="col-sm-3">
                                    <div class="tt-offset-7">
                                        <a href="<?php echo e(route('frontend.search',['category_id'])); ?>" class="tt-promo-02">
                                            <img class="img-category img-responsive" src="<?php echo e($cat->imageLargeLink); ?>"
                                                 data-src="<?php echo e($cat->imageLargeLink); ?>"
