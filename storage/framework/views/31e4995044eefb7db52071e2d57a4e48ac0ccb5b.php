            ...
            <form class="horizontal-form" role="form" method="POST" action="<?php echo e(route('backend.admin.user.store')); ?>"
                ...
                <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group <?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                                            ...
                                            <input id="name_ar" type="text" class="form-control" name="name"
                                                   value="<?php echo e(old('name')); ?>" placeholder="<?php echo e(trans('general.name')); ?>"
                                                   required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group <?php echo e($errors->has('service_en') ? ' has-error' : ''); ?>">
                                            ...
                                            <input id="service_en" type="text" class="form-control" name="service_en"
                                                   value="<?php echo e(old('service_en')); ?>"
                                                   placeholder="<?php echo e(trans('general.service_en')); ?>" required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group <?php echo e($errors->has('service_ar') ? ' has-error' : ''); ?>">
                                            ...
                                            <input id="service_ar" type="text" class="form-control" name="service_ar"
                                                   value="<?php echo e(old('service_ar')); ?>"
                                                   placeholder="<?php echo e(trans('general.service_ar')); ?>" required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group <?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                                            <label for="password" class="control-label"><?php echo e(trans('general.password')); ?>

                                                *</label>
                                            <input id="password" type="password" class="form-control" name="password"
                                                   value="" placeholder="<?php echo e(trans('general.password')); ?>" required
                                                   autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group <?php echo e($errors->has('password_confirmation') ? ' has-error' : ''); ?>">
                                            ...
                                            <input id="password_confirmation" type="text" class="form-control"
                                                   ...
                                                   placeholder="<?php echo e(trans('general.password_confirmation')); ?>" required
                                                   autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                                            ...
                                            <input id="email" type="text" class="form-control" name="email"
                                                   value="<?php echo e(old('email')); ?>" placeholder="<?php echo e(trans('general.email')); ?>"
                                                   required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group<?php echo e($errors->has('phone') ? ' has-error' : ''); ?>">
                                            ...
                                            <input id="phone" type="text" class="form-control" name="phone"
                                                   placeholder="<?php echo e(trans('general.phone')); ?>" value="<?php echo e(old('phone')); ?>"
                                                   autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" name="banner"
                                                   placeholder="<?php echo e(trans('general.banner')); ?>" required>
                                            <div class="help-block text-left">
                                                W * H - Best fit ['1080', '1440'] pixels
                                            </div>
                                        </div>
                    ...
                    <div class="portlet box blue ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i> <?php echo e(trans('general.user_more_details')); ?>
                        ...
                        <div class="portlet-body form">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group<?php echo e($errors->has('area') ? ' has-error' : ''); ?>">
                                            ...
                                            <input id="area" type="text" class="form-control" name="area"
                                                   placeholder="<?php echo e(trans('general.area')); ?>" value="<?php echo e(old('area')); ?>"
                                                   autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group<?php echo e($errors->has('block') ? ' has-error' : ''); ?>">
                                            ...
                                            <input id="block" type="text" class="form-control" name="block"
                                                   placeholder="<?php echo e(trans('general.block')); ?>" value="<?php echo e(old('block')); ?>"
                                                   autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group<?php echo e($errors->has('floor') ? ' has-error' : ''); ?>">
                                            ...
                                            <input id="floor" type="text" class="form-control" name="floor"
                                                   placeholder="<?php echo e(trans('general.floor')); ?>" value="<?php echo e(old('floor')); ?>"
                                                   autofocus>
                            ...
                            <div class="portlet box blue ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-gift"></i> <?php echo e(trans('general.user_address_details')); ?>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group<?php echo e($errors->has('facebook') ? ' has-error' : ''); ?>">
                                                    ...
                                                    <input id="facebook" type="text" class="form-control"
                                                           name="facebook" placeholder="<?php echo e(trans('general.facebook')); ?>"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group<?php echo e($errors->has('whatsapp') ? ' has-error' : ''); ?>">
                                                    ...
                                                    <input id="whatsapp" type="text" class="form-control"
                                                           name="whatsapp" placeholder="<?php echo e(trans('general.whatsapp')); ?>"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group<?php echo e($errors->has('iphone') ? ' has-error' : ''); ?>">
                                                    ...
                                                    <input id="iphone" type="text" class="form-control" name="iphone"
                                                           placeholder="<?php echo e(trans('general.iphone')); ?>"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group<?php echo e($errors->has('latitude') ? ' has-error' : ''); ?>">
                                                    ...
                                                    <input id="latitude" type="text" class="form-control"
                                                           name="latitude" placeholder="<?php echo e(trans('general.latitude')); ?>"
