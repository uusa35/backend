                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <button type="button" style="background-color: <?php echo e($attribute->color->name_en); ?>; color : black; font-weight: bolder" class="btn green btn-sm btn-outline" data-toggle="dropdown"> <?php echo e($attribute->color->name_en); ?>
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li>
                                            <a data-toggle="modal" href="#" data-target="#basic" data-title="Delete" data-content="Are you sure you want to delete attribute ? " data-form_id="delete-<?php echo e($attribute->id); ?>">
                                                <i class="fa fa-fw fa-recycle"></i> <?php echo e(trans('general.delete')); ?></a>
                                            <form method="post" id="delete-<?php echo e($attribute->id); ?>" action="<?php echo e(route('backend.attribute.destroy',$attribute->id)); ?>">
                                                <?php echo csrf_field(); ?>
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu">
                                        ...
                                        <li>
                                            <a href="<?php echo e(route('backend.attribute.create',['product_id' => $element->id])); ?>">
                                                <i class="fa fa-fw fa-plus-square"></i> <?php echo e(trans('general.assign_new_attribute')); ?></a>
                                        </li>
                                        ...
                                        <li>
                                            <a data-toggle="modal" href="#" data-target="#basic" data-title="Delete" data-content="Are you sure you want to delete <?php echo e($element->name); ?>? " data-form_id="delete-<?php echo e($element->id); ?>">
                                                <i class="fa fa-fw fa-recycle"></i> <?php echo e(trans('general.delete')); ?></a>
                                            <form method="post" id="delete-<?php echo e($element->id); ?>" action="<?php echo e(route('backend.product.destroy',$element->id)); ?>">
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" name="_method" value="delete" />
                                                <button type="submit" class="btn btn-del hidden">
                                                    <i class="fa fa-fw fa-times-circle"></i> <?php echo e(trans('general.delete')); ?>
                                        ...
                                        <li>
                                            <a href="<?php echo e(route('backend.product.restore',$element->id)); ?>">
                                                <i class="fa fa-fw fa-window-restore"></i> <?php echo e(trans('general.restore')); ?></a>
                                        </li>
                                        <?php endif; ?>
                                    </ul>
                                </div>
