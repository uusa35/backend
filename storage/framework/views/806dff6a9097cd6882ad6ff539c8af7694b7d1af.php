                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group <?php echo e($errors->has('start') ? ' has-error' : ''); ?>">
                                        <label for="start" class="control-label"><?php echo e(trans('general.start')); ?>*</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group <?php echo e($errors->has('day_no') ? ' has-error' : ''); ?>">
                                        <label for="day_no" class="control-label"><?php echo e(trans('general.day_no')); ?> *</label>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="single" class="control-label"><?php echo e(trans('general.user')); ?></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="single" class="control-label"><?php echo e(trans('general.service')); ?></label>
                                        <select id="single" class="form-control select2">
                                            <option></option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="single" class="control-label"><?php echo e(trans('general.day')); ?></label>
                                        <select id="single" class="form-control select2">
                                            <option></option>
