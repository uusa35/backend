...
<?php $__env->startSection('content'); ?>
    <div class="portlet box blue">
        ...
        <div class="portlet-body">
            ...
            trans('message.new_service')], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <div class="portlet-body form">
                <form class="horizontal-form" role="form" method="POST" action="<?php echo e(route('backend.service.store')); ?>"
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group <?php echo e($errors->has('sku') ? ' has-error' : ''); ?>">
                                                ...
                                                <input id="sku" type="text" class="form-control tooltips"
                                                       ...
                                                       data-original-title="<?php echo e(trans('message.sku')); ?>" name="sku"
                                                       value="<?php echo e(old('sku')); ?>" placeholder="<?php echo e(trans('general.sku')); ?>"
                                                       required autofocus>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group <?php echo e($errors->has('name_ar') ? ' has-error' : ''); ?>">
                                                <label for="name_ar"
                                                       class="control-label"><?php echo e(trans('general.name_ar')); ?>
                                                ...
                                                <input id="name_ar" type="text" class="form-control tooltips"
                                                       ...
                                                       placeholder="<?php echo e(trans('general.name_ar')); ?>" required autofocus>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group <?php echo e($errors->has('name_en') ? ' has-error' : ''); ?>">
                                                <label for="name_en"
                                                       class="control-label"><?php echo e(trans('general.name_en')); ?>
                                                ...
                                                <input id="name_en" type="text" class="form-control tooltips"
                                                       ...
                                                       placeholder="<?php echo e(trans('general.name_en')); ?>" required autofocus>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group <?php echo e($errors->has('duration') ? ' has-error' : ''); ?>">
                                                <label for="duration"
                                                       class="control-label"><?php echo e(trans('general.duration')); ?>*</label>
                                                <input id="duration" type="number" class="form-control tooltips"
                                                       data-container="body" data-placement="top"
                                                       data-original-title="<?php echo e(trans('message.duration')); ?>"
                                                       name="duration" value="<?php echo e(old('duration')); ?>"
                                                       placeholder="<?php echo e(trans('general.duration')); ?>" required autofocus>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group <?php echo e($errors->has('delivery_time') ? ' has-error' : ''); ?>">
                                                ...
                                                <input id="delivery_time" type="number" class="form-control tooltips"
                                                       ...
                                                       name="delivery_time" value="<?php echo e(old('delivery_time')); ?>"
                                                       placeholder="<?php echo e(trans('general.delivery_time')); ?>" required
                                                       autofocus>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group <?php echo e($errors->has('setup_time') ? ' has-error' : ''); ?>">
                                                <label for="setup_time"
                                                       class="control-label"><?php echo e(trans('general.setup_time')); ?>*</label>
                                                <input id="setup_time" type="number" maxlength="1" max="10"
                                                       class="form-control tooltips" data-container="body"
                                                       data-placement="top"
                                                       data-original-title="<?php echo e(trans('message.setup_time')); ?>"
                                                       name="setup_time" value="<?php echo e(old('setup_time')); ?>"
                                                       placeholder="<?php echo e(trans('general.setup_time')); ?>" required
                                                       autofocus>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group <?php echo e($errors->has('individuals') ? ' has-error' : ''); ?>">
                                                <label for="individuals"
                                                       class="control-label"><?php echo e(trans('general.individuals')); ?>

                                                    *</label>
                                                <input id="individuals" maxlength="2" max="99" type="number"
                                                       class="form-control tooltips" data-container="body"
                                                       data-placement="top"
                                                       data-original-title="<?php echo e(trans('message.individuals')); ?>"
                                                       name="individuals" value=""
                                                       placeholder="<?php echo e(trans('general.individuals')); ?>" required
                                                       autofocus>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group <?php echo e($errors->has('delivery_charge') ? ' has-error' : ''); ?>">
                                                <label for="delivery_charge"
                                                       class="control-label"><?php echo e(trans('general.delivery_charge')); ?>

                                                    *</label>
                                                <input id="delivery_charge" type="number" class="form-control tooltips"
                                                       data-container="body" data-placement="top"
                                                       data-original-title="<?php echo e(trans('message.delivery_charge')); ?>"
                                                       name="delivery_charge" value=""
                                                       placeholder="<?php echo e(trans('general.delivery_charge')); ?>" required
                                                       autofocus>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group<?php echo e($errors->has('price') ? ' has-error' : ''); ?>">
                                                ...
                                                <input id="price" type="text" class="form-control tooltips"
                                                       data-container="body" data-placement="top"
                                                       data-original-title="<?php echo e(trans('message.price')); ?>" name="price"
                                                       value="<?php echo e(old('price')); ?>"
                                                       placeholder="<?php echo e(trans('general.price')); ?>" required autofocus>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group<?php echo e($errors->has('sale_price') ? ' has-error' : ''); ?>">
                                                <label for="sale_price"
                                                       class="control-label"><?php echo e(trans('general.sale_price')); ?>
                                                ...
                                                <input id="sale_price" type="text" class="form-control tooltips"
                                                       ...
                                                       placeholder="<?php echo e(trans('general.sale_price')); ?> " required
                                                       autofocus>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="notes_ar"
                                                       class="control-label"><?php echo e(trans('general.notes_ar')); ?></label>
                                                <textarea type="text" class="form-control tooltips"
                                                          data-container="body" data-placement="top"
                                                          data-original-title="<?php echo e(trans('message.notes_ar')); ?>"
                                                          id="notes_ar" name="notes_ar" aria-multiline="true"
                                                          maxlength="500" <?php echo e(old('notes_ar')); ?>></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="notes_en"
                                                       class="control-label"><?php echo e(trans('general.notes_en')); ?></label>
                                                <textarea type="text" class="form-control tooltips"
                                                          data-container="body" data-placement="top"
                                                          data-original-title="<?php echo e(trans('message.notes_en')); ?>"
                                                          id="notes_en" name="notes_en" aria-multiline="true"
                                                          maxlength="500"><?php echo e(old('notes_en')); ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group<?php echo e($errors->has('keywords') ? ' has-error' : ''); ?>">
                                                ...
                                                <input id="keywords" type="text" class="form-control tooltips"
                                                       ...
                                                       name="keywords" placeholder="<?php echo e(trans('general.keywords')); ?>"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control tooltips" data-container="body"
                                                       data-placement="top"
                                                       data-original-title="<?php echo e(trans('message.more_images')); ?>"
                                                       name="images[]" placeholder="<?php echo e(trans('message.more_images')); ?>"
                                                       type="file" multiple/>
                                                <div class="help-block text-left">
                                                    W * H - Best fit ['1080', '1440'] pixels
                                                </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group<?php echo e($errors->has('video_url_one') ? ' has-error' : ''); ?>">
                                                ...
                                                <input id="video_url_one" type="text" class="form-control tooltips"
                                                       ...
                                                       value="<?php echo e(old('video_url_one')); ?>" autofocus>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group<?php echo e($errors->has('video_url_two') ? ' has-error' : ''); ?>">
                                                ...
                                                <input id="video_url_two" type="text" class="form-control tooltips"
                                                       ...
                                                       value="<?php echo e(old('video_url_two')); ?>" autofocus>
                                            ...
                                            <div class="form-group<?php echo e($errors->has('start_sale') ? ' has-error' : ''); ?>">
                                                ...
                                                <div class="input-group date form_datetime">
                                                    <input type="text" readonly style="direction: ltr !important;"
                                                           ...
                                                           name="start_sale"
                                                           value="<?php echo e(old('start_sale') ? old('start_sale') : '01 January 2019 - 07:55'); ?>"
                                                           required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date form_datetime">
                                                    <input type="text" class="form-control tooltips"
                                                           ...
                                                           value="<?php echo e(old('end_sale') ? old('end_sale') : '01 January 2019 - 07:55'); ?>"
                                                           required>
                                                    <span class="input-group-btn"><button class="btn default date-set"
                                                                                          type="button"><i
                                                                    class="fa fa-calendar"></i></button></span>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group<?php echo e($errors->has('booking_limit') ? ' has-error' : ''); ?>">
                                                <label for="booking_limit"
                                                       class="control-label"><?php echo e(trans('general.booking_limit')); ?></label>
                                                <input id="booking_limit" type="number" class="form-control tooltips"
                                                       data-container="body" data-placement="top"
                                                       data-original-title="<?php echo e(trans('message.booking_limit')); ?>"
                                                       name="booking_limit"
                                                       placeholder="<?php echo e(trans('general.booking_limit')); ?>"
                                                       value="<?php echo e(old('booking_limit')); ?>" autofocus>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="on_sale" id="optionsRadios2" checked
                                                           value="0"> <?php echo e(trans('general.not_on_sale')); ?></label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="exclusive" id="optionsRadios2" checked
                                                           value="0"> <?php echo e(trans('general.not_exclusive')); ?></label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="on_new" id="optionsRadios2" checked
                                                           value="0"> <?php echo e(trans('general.not_on_new')); ?></label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="is_available" id="optionsRadios2" checked
                                                           value="0"> <?php echo e(trans('general.not_is_available')); ?></label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="is_hot_deal" id="optionsRadios2" checked
                                                           value="0"> <?php echo e(trans('general.not_is_hot_deal')); ?></label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label sbold tooltips" data-container="body"
                                                       data-placement="top"
                                                       data-original-title="<?php echo e(trans('message.multi_booking')); ?>"><?php echo e(trans('general.multi_booking')); ?></label></br>
                                                <label class="radio-inline">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="multi_booking" id="optionsRadios2" checked
                                                           value="0"> <?php echo e(trans('general.not_multi_booking')); ?></label>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="on_home" id="optionsRadios2" checked
                                                           value="0"> <?php echo e(trans('general.not_on_home')); ?></label>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
