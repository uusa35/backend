...
<div class="portlet box blue">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="<?php echo e(route('backend.admin.country.store')); ?>" role="form" method="post" class="horizontal-form" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="form-body">
                <h3 class="form-section"><?php echo e(trans('general.create_country')); ?></h3>
                <div class="portlet box blue ">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="name_en" name="name_en" class="form-control" value="<?php echo e(old('name_en')); ?>" placeholder="<?php echo e(trans('general.name_en')); ?>" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="order" name="order" class="form-control" placeholder="<?php echo e(trans('general.order')); ?>" value="<?php echo e(old('order')); ?>" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" id="minimum_shipment_charge" name="minimum_shipment_charge" class="form-control" value="<?php echo e(old('minimum_shipment_charge')); ?>" placeholder="<?php echo e(trans('general.minimum_shipment_charge')); ?>" required>

                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label"><?php echo e(trans('general.fixed_shipment_charge')); ?>*</label>
                            <input type="number" id="fixed_shipment_charge" name="fixed_shipment_charge" class="form-control" value="<?php echo e(old('fixed_shipment_charge')); ?>" placeholder="<?php echo e(trans('general.fixed_shipment_charge')); ?>" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" id="longitude" name="longitude" class="form-control" value="<?php echo e(old('longitude')); ?>" placeholder="<?php echo e(trans('general.longitude')); ?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" id="latitude" name="latitude" class="form-control" value="<?php echo e(old('latitude')); ?>" placeholder="<?php echo e(trans('general.latitude')); ?>">
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-list">
                                <label class="radio-inline">
                                    <input type="radio" name="active" id="optionsRadios1" value="1" <?php echo e(old('is_active') ? 'checked' : null); ?>> <?php echo e(trans('general.active')); ?> </label>
                                <label class="radio-inline">
                                    <input type="radio" name="active" id="optionsRadios2" value="0" <?php echo e(old('is_active')  ? 'checked' : null); ?> checked>
                    ...
                    <div class="col-md-4" style="padding-left : 50px;">
                        <div class="form-group">
                            ...
                            <div class="radio-list">
                                <label class="radio-inline">
                                    <input type="radio" name="has_currency" id="optionsRadios1" value="1" <?php echo e(old('has_currency') ? 'checked' : null); ?>> <?php echo e(trans('general.has_currency')); ?> </label>
                                <label class="radio-inline">
                                    <input type="radio" name="has_currency" id="optionsRadios2" value="0" <?php echo e(old('has_currency')  ? 'checked' : null); ?>checked>
                    ...
                    <div class="col-md-4" style="padding-left : 50px;">
                        <div class="form-group">
                            ...
                            <div class="radio-list">
                                <label class="radio-inline">
                                    <input type="radio" name="is_local" id="optionsRadios1" value="1" <?php echo e(old('is_local') ? 'checked' : null); ?>> <?php echo e(trans('general.is_local')); ?> </label>
                                <label class="radio-inline">
                                    <input type="radio" name="is_local" id="optionsRadios2" value="0" <?php echo e(old('is_local')  ? 'checked' : null); ?> checked>
