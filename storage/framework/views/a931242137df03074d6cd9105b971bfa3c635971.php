<?php echo $__env->make('frontend.wokiee.partials.styles', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<style type="text/css">
    .btn,
    .tt-color-scheme-02,
    .tt-back-to-top,
    ...
    {
        background-color: <?php echo e($settings->main_theme_color); ?> !important;
    }
    ...
    {
        color : <?php echo e($settings->title_theme_color); ?> !important;
    }

    .tt-collapse-title {
        border-bottom: 1px solid <?php echo e($settings->main_theme_color); ?>;
    }
