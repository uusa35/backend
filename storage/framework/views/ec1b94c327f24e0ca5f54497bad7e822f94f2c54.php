        ...
        <div class="page-top">
            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-language" style="background-color: <?php echo e(app()->isLocale('ar') ? 'white' : 'transparent'); ?>; padding-right: 20px; padding-left: 20px; ">
                        <a href="<?php echo e(route('backend.language.change','ar')); ?>" class="dropdown-toggle" data-close-others="true">
                            
                            <span class="langname"><i class="fa fa-fw fa-language"></i>&nbsp; <?php echo e(trans('general.arabic')); ?> </span>
                        </a>
                    </li>
                    <li class="dropdown dropdown-language" style="background-color: <?php echo e(app()->isLocale('en') ? 'white' : 'transparent'); ?>; padding-right: 20px; padding-left: 20px; ">
                        <a href="<?php echo e(route('backend.language.change','en')); ?>" class="dropdown-toggle" data-close-others="true">
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('backend.order.show',$element->id)); ?>">
                                            <span class="photo">
                                                ...
                                                <img src="<?php echo e(asset(env('THUMBNAIL').$element->images->first()->image)); ?>" class="img-circle" alt="">
                                                <?php else: ?>
                                                <img src="<?php echo e(asset(env('THUMBNAIL').$settings->logo)); ?>" class="img-circle" alt="">
                                                <?php endif; ?>
                                            </span>
                                            <span class="subject">
                    ...
                    <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-default">
                            <li>
                                <a href="#">
                                    <span class="username username-hide-on-mobile"><i class="fa fa-fw fa-university"></i><?php echo e(trans('general.role')); ?>
                    ...
                    <li class="dropdown dropdown-user">
                        <a href="<?php echo e(url('/logout')); ?>" class="dropdown-toggle" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
