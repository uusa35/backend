<?php $__env->startSection('breadcrumbs'); ?>
    <?php echo e(Breadcrumbs::render('backend.product.edit', $element)); ?>
                ...
                <div class="portlet-body">
                    ...
                    <div class="portlet-body form">
                        <form class="horizontal-form" role="form" method="POST"
                              action="<?php echo e(route('backend.product.update', $element->id)); ?>"
                              enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('put'); ?>
                            <div class="form-body">
                                <h3 class="form-section"><?php echo e(trans('general.edit_product')); ?></h3>
                                <div class="mt-element-step">
                                    <div class="row step-default">
                                        <div class="col-md-6 bg-success mt-step-col <?php echo e(Route::currentRouteName() === 'backend.product.edit' ? 'active' : null); ?>">
                                        ...
                                        <div class="col-md-6 bg-grey mt-step-col <?php echo e(Route::currentRouteName() === 'backend.attribute.edit' ? 'active' : null); ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="col-md-4">
                                                        <div class="form-group <?php echo e($errors->has('sku') ? ' has-error' : ''); ?>">
                                                            <label for="sku"
                                                                   class="control-label"><?php echo e(trans('general.sku')); ?>

                                                                *</label>
                                                            <input id="sku" type="text" class="form-control tooltips"
                                                                   data-container="body" data-placement="top"
                                                                   data-original-title="<?php echo e(trans('message.sku')); ?>"
                                                                   name="sku" value="<?php echo e($element->sku); ?>"
                                                                   placeholder="<?php echo e(trans('general.sku')); ?>" required
                                                                   autofocus>
                                                ...
                                                <strong>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group <?php echo e($errors->has('name_ar') ? ' has-error' : ''); ?>">
                                                            <label for="name_ar"
                                                                   class="control-label"><?php echo e(trans('general.name_arabic')); ?>
                                                            ...
                                                            <input id="name_ar" type="text"
                                                                   ...
                                                                   name="name_ar" value="<?php echo e($element->name_ar); ?>"
                                                                   placeholder="<?php echo e(trans('general.name_arabic')); ?>"
                                                                   required autofocus>
                                                ...
                                                <strong>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group<?php echo e($errors->has('name_en') ? ' has-error' : ''); ?>">
                                                            <label for="name_en"
                                                                   class="control-label"><?php echo e(trans('general.name_english')); ?>

                                                                *</label>
                                                            <input id="name_en" type="text"
                                                                   class="form-control tooltips" data-container="body"
                                                                   data-placement="top"
                                                                   data-original-title="<?php echo e(trans('message.name_en')); ?>"
                                                                   name="name_en" value="<?php echo e($element->name_en); ?>"
                                                                   placeholder="<?php echo e(trans('general.name_english')); ?>"
                                                                   required autofocus>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group<?php echo e($errors->has('delivery_time') ? ' has-error' : ''); ?>">
                                                            <label for="delivery_time"
                                                                   class="control-label"><?php echo e(trans('general.delivery_time')); ?>

                                                                *</label>
                                                            <input id="delivery_time" type="number" max="99"
                                                                   maxlength="2" class="form-control tooltips"
                                                                   data-container="body" data-placement="top"
                                                                   data-original-title="<?php echo e(trans('message.delivery_time')); ?>"
                                                                   name="delivery_time"
                                                                   value="<?php echo e($element->delivery_time); ?>"
                                                                   placeholder="<?php echo e(trans('general.delivery_time')); ?>"
                                                                   required autofocus>
                                                ...
                                                <strong>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group<?php echo e($errors->has('price') ? ' has-error' : ''); ?>">
                                                            <label for="price"
                                                                   class="control-label"><?php echo e(trans('general.price')); ?>

                                                                *</label>
                                                            <input id="price" type="text" class="form-control tooltips"
                                                                   data-container="body" data-placement="top"
                                                                   data-original-title="<?php echo e(trans('message.price')); ?>"
                                                                   name="price" value="<?php echo e($element->price); ?>"
                                                                   placeholder="<?php echo e(trans('general.price')); ?>"
                                                ...
                                                <strong>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group<?php echo e($errors->has('weight') ? ' has-error' : ''); ?>">
                                                            <label for="weight"
                                                                   class="control-label"><?php echo e(trans('general.weight')); ?>

                                                                *</label>
                                                            <input id="weight" type="number" maxlength="1" max="10"
                                                                   class="form-control tooltips" data-container="body"
                                                                   data-placement="top"
                                                                   data-original-title="<?php echo e(trans('message.weight')); ?>"
                                                                   name="weight" value="<?php echo e($element->weight); ?>"
                                                                   placeholder="<?php echo e(trans('general.weight')); ?>" required
                                                                   autofocus>
                                                ...
                                                <div class="col-lg-12">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="user_id" class="form-control tooltips"
                                                                    ...
                                                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($user->id); ?>" <?php echo e($element->user_id === $user->id ? 'selected' : null); ?>><?php echo e($user->slug); ?></option>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="single"
                                                                   class="control-label"><?php echo e(trans('general.shipment_package')); ?>

                                                                *</label>
                                                            <select id="" name="shipment_package_id"
                                                                    class="form-control tooltips" data-container="body"
                                                                    data-placement="top"
                                                                    data-original-title="<?php echo e(trans('message.shipment_package')); ?>"
                                                                    required>
                                                                ...
                                                                <?php $__currentLoopData = $shipment_packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shipment_package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($shipment_package->id); ?>" <?php echo e($element->shipment_package_id === $shipment_package->id ? 'selected' : null); ?>>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="brand_id"
                                                                   class="control-label"><?php echo e(trans('general.brand')); ?>

                                                                *</label>
                                                            <select id="" name="brand_id" class="form-control tooltips"
                                                                    data-container="body" data-placement="top"
                                                                    data-original-title="<?php echo e(trans('message.brand')); ?>">
                                                                <option value=""><?php echo e(trans('general.choose_brand')); ?></option>
                                                                <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($brand->id); ?>" <?php echo e($element->brand->id === $brand->id ? 'selected' : null); ?>><?php echo e($brand->slug); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-12">
                                                                ...
                                                                <select multiple="multiple" class="multi-select"
                                                                    ...
                                                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($category->id); ?>"
                                                                                <?php echo e(in_array($category->id,$element->categories->pluck('id')->unique()->flatten()->toArray()) ? 'selected' : null); ?>

                                                                                style="background-color: <?php echo e($category->isParent ? 'lightblue' : null); ?>">
                                                                            <?php echo e($category->name); ?></option>
                                                                        <?php if(!$category->children->isEmpty()): ?>
                                                                            <?php $__currentLoopData = $category->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option value="<?php echo e($child->id); ?>"
                                                                                        <?php echo e(in_array($child->id,$element->categories->pluck('id')->unique()->flatten()->toArray()) ? 'selected' : null); ?>
                                                                                ...
                                                                                <?php if(!$child->children->isEmpty()): ?>
                                                                                    <?php $__currentLoopData = $child->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subChild): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                        <option value="<?php echo e($subChild->id); ?>"
                                                                                                <?php echo e(in_array($subChild->id,$element->categories->pluck('id')->unique()->flatten()->toArray()) ? 'selected' : null); ?>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="file"
                                                                   class="control-label"><?php echo e(trans('general.main_image')); ?>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="file"
                                                                   class="control-label"><?php echo e(trans('general.more_images')); ?>

                                                                *</label>

                                                            <input class="form-control tooltips" data-container="body"
                                                                   data-placement="top"
                                                                   data-original-title="<?php echo e(trans('message.more_iamges')); ?>"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 text-right">
                                                    <button class="btn btn-success tooltips" data-container="body"
                                                            data-placement="top"
                                                            data-original-title="<?php echo e(trans('message.speed_saving_product')); ?>"
                                                            type="submit"><?php echo e(trans('general.save')); ?></button>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="single"
                                                               class="control-label"><?php echo e(trans('general.color')); ?>

                                                            *</label>
                                                        <select id="color_id" name="color_id"
                                                                class="form-control tooltips" data-container="body"
                                                                data-placement="top"
                                                                data-original-title="<?php echo e(trans('message.color')); ?>">
                                                            <option value=""><?php echo e(trans('general.choose_color')); ?></option>
                                                            <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($color->id); ?>" <?php echo e($element->color_id === $color->id ? 'selected' : null); ?>><?php echo e($color->name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="size_id"
                                                               class="control-label"><?php echo e(trans('general.size')); ?>

                                                            *</label>
                                                        <select id="size_id" name="size_id"
                                                                class="form-control tooltips" data-container="body"
                                                                data-placement="top"
                                                                data-original-title="<?php echo e(trans('message.size')); ?>">
                                                            <option value=""><?php echo e(trans('general.choose_size')); ?></option>
                                                            <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($size->id); ?>" <?php echo e($element->size_id === $size->id ? 'selected' : null); ?>><?php echo e($size->name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" class="form-control tooltips"
                                                               data-container="body" data-placement="top"
                                                               data-original-title="<?php echo e(trans('message.image_chart')); ?>"
                                                               name="size_chart_image"
                                                               placeholder="<?php echo e(trans('general.image_chart')); ?>">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group<?php echo e($errors->has('sale_price') ? ' has-error' : ''); ?>">
                                                        <label for="sale_price"
                                                               class="control-label"><?php echo e(trans('general.sale_price')); ?></label>
                                                        <input id="sale_price" type="text" class="form-control tooltips"
                                                               data-container="body" data-placement="top"
                                                               data-original-title="<?php echo e(trans('message.sale_price')); ?>"
                                                               name="sale_price" maxlength="5"
                                                               value="<?php echo e($element->sale_price); ?>"
                                                               placeholder="<?php echo e(trans('general.sale_price')); ?>"
                                                               autofocus>
                                            ...
                                            <strong>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" class="form-control tooltips"
                                                                  data-container="body" data-placement="top"
                                                                  data-original-title="<?php echo e(trans('message.description_ar')); ?>"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" class="form-control tooltips"
                                                                  data-container="body" data-placement="top"
                                                                  data-original-title="<?php echo e(trans('message.description_en')); ?>"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group<?php echo e($errors->has('notes_ar') ? ' has-error' : ''); ?>">
                                                        <label for="notes_ar"
                                                               class="control-label"><?php echo e(trans('general.notes_arabic')); ?></label>
                                                        <input id="notes_ar" type="text" class="form-control tooltips"
                                                               data-container="body" data-placement="top"
                                                               data-original-title="<?php echo e(trans('message.notes_ar')); ?>"
                                                               name="notes_ar" value="<?php echo e($element->notes_ar); ?>"
                                                               placeholder="<?php echo e(trans('general.notes_arabic')); ?> "
                                                               autofocus>
                                            ...
                                            <strong>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group<?php echo e($errors->has('notes_en') ? ' has-error' : ''); ?>">
                                                        <label for="notes_en"
                                                               class="control-label"><?php echo e(trans('general.notes_english')); ?></label>
                                                        <input id="notes_en" type="text" class="form-control tooltips"
                                                               data-container="body" data-placement="top"
                                                               data-original-title="<?php echo e(trans('message.notes_en')); ?>"
                                                               name="notes_en" value="<?php echo e($element->notes_en); ?>"
                                                               placeholder="<?php echo e(trans('general.notes_english')); ?>"
                                                               autofocus>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group<?php echo e($errors->has('keywords') ? ' has-error' : ''); ?>">
                                                        ...
                                                        <input id="keywords" type="text" class="form-control tooltips"
                                                               ...
                                                               name="keywords" value="<?php echo e($element->keywords); ?>"
                                                               placeholder="<?php echo e(trans('general.keywords')); ?>" autofocus>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group<?php echo e($errors->has('video_url_one') ? ' has-error' : ''); ?>">
                                                        <label for="video_url_one"
                                                               class="control-label"><?php echo e(trans('general.video_url_one')); ?></label>
                                                        <input id="video_url_one" type="url"
                                                               class="form-control tooltips" data-container="body"
                                                               data-placement="top"
                                                               data-original-title="<?php echo e(trans('message.video_url_one')); ?>"
                                                               name="video_url_one"
                                                               value="<?php echo e($element->video_url_one); ?>"
                                                               placeholder="<?php echo e(trans('general.video_url_one')); ?>"
                                                               autofocus>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group<?php echo e($errors->has('video_url_two') ? ' has-error' : ''); ?>">
                                                        <label for="video_url_two"
                                                               class="control-label"><?php echo e(trans('general.video_url_two')); ?></label>
                                                        <input id="video_url_two" type="url"
                                                               class="form-control tooltips" data-container="body"
                                                               data-placement="top"
                                                               data-original-title="<?php echo e(trans('message.video_url_two')); ?>"
                                                               name="video_url_two"
                                                               value="<?php echo e($element->video_url_two); ?>"
                                                               placeholder="<?php echo e(trans('general.video_url_two')); ?>"
                                                               autofocus>
                                            ...
                                            <strong>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group<?php echo e($errors->has('start_sale') ? ' has-error' : ''); ?>">
                                                        <label for="start_sale"
                                                               class="control-label"><?php echo e(trans('general.start_sale_date')); ?></label>
                                                        <div class="input-group date form_datetime">
                                                            <input type="text" readonly
                                                                   style="direction: ltr !important;"
                                                                   class="form-control tooltips" data-container="body"
                                                                   data-placement="top"
                                                                   data-original-title="<?php echo e(trans('message.start_sale_date')); ?>"
                                                                   name="start_sale"
                                                                   value="<?php echo e($element->start_sale ? $element->start_sale : \Carbon\Carbon::now()->format('d F Y - h:i')); ?>"
                                                                   required>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group date form_datetime">
                                                            <input type="text" class="form-control tooltips"
                                                                   data-container="body" data-placement="top"
                                                                   data-original-title="<?php echo e(trans('message.end_sale_date')); ?>"
                                                                   readonly style="direction: ltr !important;"
                                                                   name="end_sale"
                                                                   value="<?php echo e($element->end_sale ? $element->end_sale : \Carbon\Carbon::now()->addDay(1)->format('d F Y - h:i')); ?>"
                                                                   required>
                                                            <span class="input-group-btn"><button
                                                                        class="btn default date-set" type="button"><i
                                                                            class="fa fa-calendar"></i></button></span>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group<?php echo e($errors->has('quantity') ? ' has-error' : ''); ?>">
                                                        <label for="quantity"
                                                               class="control-label"><?php echo e(trans('general.quantity')); ?></label>
                                                        <input id="quantity" type="text" class="form-control tooltips"
                                                               data-container="body" data-placement="top"
                                                               data-original-title="<?php echo e(trans('message.quantity')); ?>"
                                                               name="qty" maxlength="5" value="<?php echo e($element->qty); ?>"
                                                               placeholder="<?php echo e(trans('general.quantity')); ?>" autofocus>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select multiple="multiple" class="multi-select"
                                                                ...
                                                                <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($tag->id); ?>" <?php echo e(in_array($tag->id,$element->tags->pluck('id')->unique()->flatten()->toArray()) ? 'selected' : null); ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="control-label sbold tooltips"
                                                               data-container="body" data-placement="top"
                                                               data-original-title="<?php echo e(trans('message.check_stock')); ?>">
                            ...
                            <div class="form-actions right">
                                ...
                                <a href="<?php echo url()->previous(); ?>"
                                   class="btn btn-danger"><?php echo e(trans('general.cancel')); ?></a>
                                
                                
                                

                                <button type="submit" class="btn btn-info">
                                    <i class="fa fa-save"></i> <?php echo e(trans("general.save")); ?>
