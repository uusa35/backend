                ...
                <div class="portlet-body">
                    ...
                    <table id="dataTable" class="table table-striped table-bordered table-hover" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <th><?php echo e(trans('general.index')); ?></th>
                            <th><?php echo e(trans('general.view')); ?></th>
                            <th><?php echo e(trans('general.create')); ?></th>
                            <th><?php echo e(trans('general.edit')); ?></th>
                        ...
                        <?php $__currentLoopData = $element->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <span class="label <?php echo e(activeLabel($role->pivot->index)); ?>"><?php echo e(activeText($role->pivot->index)); ?></span>
                                </td>
                                <td>
                                    <span class="label <?php echo e(activeLabel($role->pivot->view)); ?>"><?php echo e(activeText($role->pivot->view)); ?></span>
                                </td>
                                <td>
                                    <span class="label <?php echo e(activeLabel($role->pivot->create)); ?>"><?php echo e(activeText($role->pivot->create)); ?></span>
                                </td>
                                <td>
                                    <span class="label <?php echo e(activeLabel($role->pivot->update)); ?>"><?php echo e(activeText($role->pivot->update)); ?></span>
                                </td>
                                <td>
                                    <span class="label <?php echo e(activeLabel($role->pivot->delete)); ?>"><?php echo e(activeText($role->pivot->delete)); ?></span>
                                </td>
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-right" role="menu">
                                            <li>
                                                <a href="<?php echo e(route('backend.admin.privilege.edit',['id' => $element->id,'role_id' => $role->id])); ?>">
