...
<div class="portlet box blue">
    ...
    <div class="portlet-body">
        <?php echo $__env->make('backend.partials._admin_instructions',['title' => trans('general.pages') ,'message' => trans('message.admin_pages_message')], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group<?php echo e($errors->has('url') ? ' has-error' : ''); ?>">
                                            ...
                                            <input id="url" type="url" class="form-control" name="url" value="<?php echo e(old('url')); ?>" placeholder="<?php echo e(trans('general.url')); ?>" autofocus>
