...
<?php $__env->startSection('content'); ?>
    <div class="portlet box blue">
        ...
        <div class="portlet-body">
            <?php echo $__env->make('backend.partials._admin_instructions',['title' => trans('general.categories') ,'message' => trans('message.admin_category_message')], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <div class="portlet-body form">
                <form class="horizontal-form" role="form" method="POST"
                      action="<?php echo e(route('backend.admin.category.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <?php if(request()->has('parent_id')): ?>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group <?php echo e($errors->has('name_ar') ? ' has-error' : ''); ?>">
                                                <label for="name_ar"
                                                       class="control-label"><?php echo e(trans('general.name_ar')); ?>*</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group<?php echo e($errors->has('name_en') ? ' has-error' : ''); ?>">
                                                <label for="name_en"
                                                       class="control-label"><?php echo e(trans('general.name_en')); ?>*</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group <?php echo e($errors->has('caption_ar') ? ' has-error' : ''); ?>">
                                                <label for="caption_ar"
                                                       class="control-label"><?php echo e(trans('general.caption_ar')); ?>*</label>
                                                <input id="caption_ar" type="text" class="form-control"
                                                       name="caption_ar" value="<?php echo e(old('caption_ar')); ?>"
                                                       placeholder="<?php echo e(trans('general.caption_ar')); ?>" required
                                                       autofocus>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group<?php echo e($errors->has('caption_en') ? ' has-error' : ''); ?>">
                                                <label for="caption_en"
                                                       class="control-label"><?php echo e(trans('general.caption_en')); ?>*</label>
                                                <input id="caption_en" type="text" class="form-control"
                                                       name="caption_en" value="<?php echo e(old('caption_en')); ?>"
                                                       placeholder="<?php echo e(trans('general.caption_en')); ?>" required
                                                       autofocus>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="description"
                                                       class="control-label"><?php echo e(trans('general.description_ar')); ?></label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="description"
                                                       class="control-label"><?php echo e(trans('general.description_en')); ?></label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="active" id="optionsRadios3" checked
                                                           value="1"> <?php echo e(trans('general.active')); ?></label>
                                                <label class="radio-inline">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="is_featured" id="optionsRadios3"
                                                           value="1"> <?php echo e(trans('general.is_featured')); ?></label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="is_featured" id="optionsRadios4" checked
                                                           value="0"> <?php echo e(trans('general.not_is_featured')); ?></label>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="on_new" id="optionsRadios3"
                                                           value="1"> <?php echo e(trans('general.on_new')); ?></label>
                                                <label class="radio-inline">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="is_service" id="optionsRadios3"
                                                           value="1"> <?php echo e(trans('general.is_service')); ?></label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="is_service" id="optionsRadios4" checked
                                                           value="0"> <?php echo e(trans('general.not_is_service')); ?></label>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="is_product" id="optionsRadios3"
                                                           value="1"> <?php echo e(trans('general.is_product')); ?></label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="is_product" id="optionsRadios4" checked
                                                           value="0"> <?php echo e(trans('general.not_is_product')); ?></label>
                                            </div>
                                        </div>
                                    </div>
