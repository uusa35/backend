                                        ...
                                        <div class="form-body">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="single"
                                                                ...
                                                                *</label>
                                                            <select id="" class="form-control tooltips"
                                                                    data-container="body" data-placement="top"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 text-right">
                                                    <button class="btn btn-success tooltips"
                                                            data-container="body"
                                                            data-placement="top"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group<?php echo e($errors->has('video_url_one') ? ' has-error' : ''); ?>">
                                                        ...
                                                        <input id="video_url_one" type="text"
                                                               class="form-control tooltips" data-container="body"
                                                               data-placement="top"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group<?php echo e($errors->has('video_url_two') ? ' has-error' : ''); ?>">
                                                        ...
                                                        <input id="video_url_two" type="text"
                                                               class="form-control tooltips" data-container="body"
                                                               data-placement="top"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="radio-inline">
                                                            <input type="radio" name="home_delivery_available"
                                                                   id="optionsRadios3" value="1">
                                                            home_delivery_available</label>
                                                        <label class="radio-inline">
                                                            <input type="radio" name="home_delivery_available"
                                                                   id="optionsRadios4" checked value="0">not
                                                            home_delivery_available</label>
                                                    </div>
                                                    <span class="help-block">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="radio-inline">
                                                            <input type="radio" name="shipment_available"
                                                                   id="optionsRadios3" value="1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="radio-inline">
                                                            <input type="radio" name="on_sale_on_homepage"
                                                                   id="optionsRadios3" value="1">
