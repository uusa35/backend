                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select id="" name="shipment_package_id" class="form-control tooltips" data-container="body" data-placement="top" data-original-title="<?php echo e(trans('message.shipment_package')); ?>" required>
                                                <option value=""><?php echo e(trans('general.choose_package')); ?></option>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control tooltips" data-container="body" data-placement="top" data-original-title="<?php echo e(trans('message.main_image')); ?>" name="image" placeholder="images" type="file" required />
