                ...
                <div class="portlet-body">
                    ...
                    <div class="portlet-body form">
                        <form class="horizontal-form" role="form" method="POST"
                              action="<?php echo e(route('backend.product.store')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="form-body">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group<?php echo e($errors->has('name_en') ? ' has-error' : ''); ?>">
                                                            ...
                                                            <input id="name_en" type="text"
                                                                   ...
                                                                   name="name_en" value="<?php echo e(old('name_en')); ?>"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group<?php echo e($errors->has('weight') ? ' has-error' : ''); ?>">
                                                            ...
                                                            <input id="weight" type="text" class="form-control tooltips"
                                                                   ...
                                                                   name="weight" value="<?php echo e(old('weight')); ?>"
                                                                ...
                                                                <select multiple="multiple" class="multi-select"
                                                                    ...
                                                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($category->id); ?>"
                                                                                style="background-color: <?php echo e($category->isParent ? 'lightblue' : null); ?>"><?php echo e($category->name); ?></option>
                                                                        <?php if(!$category->children->isEmpty()): ?>
                                                                            <?php $__currentLoopData = $category->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option value="<?php echo e($child->id); ?>"
                                                                                        style="padding-left: 15px"><?php echo e($child->name); ?></option>
                                                                                <?php if(!$child->children->isEmpty()): ?>
                                                                                    <?php $__currentLoopData = $child->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subChild): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                        <option value="<?php echo e($subChild->id); ?>"
                                                                                                style="padding-left: 35px"><?php echo e($subChild->name); ?></option>
                                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                                <?php endif; ?>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php endif; ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group<?php echo e($errors->has('notes_ar') ? ' has-error' : ''); ?>">
                                                        ...
                                                        <input id="notes_ar" type="text" class="form-control tooltips"
                                                               ...
                                                               name="notes_ar" value="<?php echo e(old('notes_ar')); ?>"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group<?php echo e($errors->has('notes_en') ? ' has-error' : ''); ?>">
                                                        ...
                                                        <input id="notes_en" type="text" class="form-control tooltips"
                                                               ...
                                                               name="notes_en" value="<?php echo e(old('notes_en')); ?>"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group<?php echo e($errors->has('keywords') ? ' has-error' : ''); ?>">
                                                        ...
                                                        <input id="keywords" type="text" class="form-control tooltips"
                                                               ...
                                                               name="keywords" value="<?php echo e(old('keywords')); ?>"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group<?php echo e($errors->has('video_url_one') ? ' has-error' : ''); ?>">
                                                        ...
                                                        <input id="video_url_one" type="url"
                                                               ...
                                                               name="video_url_one" value="<?php echo e(old('video_url_one')); ?>"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group<?php echo e($errors->has('video_url_two') ? ' has-error' : ''); ?>">
                                                        ...
                                                        <input id="video_url_two" type="url"
                                                               ...
                                                               name="video_url_two" value="<?php echo e(old('video_url_two')); ?>"
                                                    ...
                                                    <div class="form-group<?php echo e($errors->has('start_sale') ? ' has-error' : ''); ?>">
                                                        ...
                                                        <div class="input-group date form_datetime">
                                                            <input type="text" readonly
                                                                   ...
                                                                   name="start_sale"
                                                                   value="<?php echo e(old('start_sale') ? old('start_sale') : \Carbon\Carbon::now()->format('d F Y - h:i')); ?>"
                                                                   required>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group date form_datetime">
                                                            <input type="text" class="form-control tooltips"
                                                                   ...
                                                                   name="end_sale"
                                                                   value="<?php echo e(old('end_sale') ? old('end_sale') : \Carbon\Carbon::now()->addDay(1)->format('d F Y - h:i')); ?>"
                                                                   required>
                                                            <span class="input-group-btn"><button
                                                                        class="btn default date-set" type="button"><i
                                                                            class="fa fa-calendar"></i></button></span>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group<?php echo e($errors->has('quantity') ? ' has-error' : ''); ?>">
                                                        ...
                                                        <input id="quantity" type="text" class="form-control tooltips"
                                                               ...
                                                               name="qty" maxlength="5" value="<?php echo e(old('quantity')); ?>"
                                ...
                                <div class="portlet box blue ">
                                    ...
                                    <div class="portlet-body form">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label class="radio-inline">
                                                            <input type="radio" name="active" id="optionsRadios4"
                                                                   value="0">
                                                            <?php echo e(trans('general.not_active')); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label class="radio-inline">
                                                            <input type="radio" name="exclusive" id="optionsRadios4"
                                                                   checked value="0">
                                                            <?php echo e(trans('general.not_exclusive')); ?></label>
                                                    </div>
                                                    <span class="help-block">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label class="radio-inline">
                                                            <input type="radio" name="is_available" id="optionsRadios4"
                                                                   checked value="0">
                                                            <?php echo e(trans('general.not_is_available')); ?></label>
                                                    </div>
                                                    <span class="help-block">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label class="radio-inline">
                                                            <input type="radio" name="is_hot_deal" id="optionsRadios8"
                                                                   checked value="0">
                                                            <?php echo e(trans('general.not_is_hot_deal')); ?></label>
                                                    </div>
                                                    <span class="help-block">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="radio-inline">
                                                            <input type="radio" name="on_sale" id="optionsRadios4"
                                                                   checked value="0">
                                                            <?php echo e(trans('general.not_on_sale')); ?></label>
                                                    </div>
                                                    <span class="help-block">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label class="radio-inline">
                                                            <input type="radio" name="on_new" id="optionsRadios4"
                                                                   checked value="0">
                                                            <?php echo e(trans('general.not_on_new')); ?></label>
                                                    </div>
                                                    <span class="help-block">
                                        ...
                                        accordingly.">
                                                            ...
                                                            <?php echo e(trans('general.check_stock')); ?></label>
                                                        <label class="radio-inline" data-toggle="tooltip"
                                                            ...
                                                            <input type="radio" name="check_stock" id="optionsRadios6"
                                                                   checked value="0">
                                                            in
                                                            <?php echo e(trans('general.not_check_stock')); ?></label>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label class="radio-inline">
                                                            <input type="radio" name="has_attributes"
                                                                   id="optionsRadios3" value="1">
                                                            <?php echo e(trans('general.has_attributes')); ?></label>
                                                        <label class="radio-inline">
                                                            <input type="radio" name="has_attributes"
                                                                   id="optionsRadios4" checked value="0">
                                                            <?php echo e(trans('general.not_has_attributes')); ?></label>
                                                    </div>
                                                    <span class="help-block">
                                        <strong><?php echo e(trans('message.on_new_instructions')); ?></strong>
                                    </span>
